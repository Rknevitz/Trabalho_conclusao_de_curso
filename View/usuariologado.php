...
<head>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
   ...
   <br>
                    <button style="margin-left: 20%;margin-top: 10px; margin-bottom: 5px; width:300px; height: 50px;  background: rgb(6, 141, 6); color: white;" class="btn btn-dark"> <a href="Registros.php" style="color:white; text-decoration: none;">
                    <h3>Registrar entrega</h3></a></button>
                    <button style="text-decoration:none;margin-top: 10px; margin-bottom: 5px; width:300px; height: 50px;  background: rgb(6, 141, 6); color: white;" class="btn btn-dark"> <a href="RegistroEntrega.php" style="color:white;  text-decoration: none;">
                    <h3>Registro de entregas</h3></a></button>
                    <button style="margin-top: 10px;margin-bottom: 5px; width:300px; height: 50px;  background: rgb(6, 141, 6); color: white;" class="btn btn-dark"> <a href="paginaEmpresa.php" style="color:white; text-decoration: none;">
                    <h3>Chat</h3></a></button>
    ...
    <div id="container" style="  width: 800px; border-radius:10px ; margin-left:22.5%; margin-top: 20px;background: rgb(6, 141, 6);">
               ...
               <?php while($usuario = $resultado->fetch_assoc()){  ?>
                <center>
                    <h1 style="color: white;font-variant: 200%;">Dados do usuário</h1>           
                    <img  style="border-radius: 50%; width: 250px;height: 250px;" src="<?php echo "Upload/$usuario[img_usuario]"?>">
                    <h3 style="font-variant: 100%;"><?php echo $usuario["nm_usuario"];?></h3>
                    <h3 style=";font-variant: 100%;"><?php echo $usuario["email_usuario"];?></h3>
                    <h3 style="font-variant: 100%;"><?php echo $usuario["celular_usuario"];?></h3>
