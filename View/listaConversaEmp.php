...
$id_de= "SELECT id_empresa FROM tb_empresa where email_empresa= '{$email}'";
    ...
    $id_de= $emp;
    $sql = "SELECT * FROM tb_chat WHERE (id_usuario='$id_para' && id_empresa= '$id_de') or (id_usuario='$id_de' && id_empresa='$id_para') ORDER BY id_chat  LIMIT 100;";    
