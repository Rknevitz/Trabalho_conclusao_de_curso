...
$consultar= "SELECT * FROM tb_usuario";
...
<br>
       <?php while($row = $resultados->fetch_assoc()){ 
                ...
                $nome = $row['nm_usuario'];
	            	$foto ="Upload/$row[img_usuario]";
       ?>
                <div class="container"   style="background: linear-gradient(to left,rgb(6, 141, 6), #999 60%); border:1px;border-radius:10px ">
                <br>
                <tr>
                ...
                <td><a style="margin-left: 90%; margin-right:0;margin-top:-100px; color:white; background: linear-gradient(to left, black ,rgb(3, 54, 14) 50%); font-size:20px; border:black;" href="ChatEmpresa.php?pagina=chat&usuario=<?php echo $empresa;?>" class="btn btn-info">Iniciar</a></td>
                </tr>
                <hr style="black"></hr>
       </div>
	<?php }?>
