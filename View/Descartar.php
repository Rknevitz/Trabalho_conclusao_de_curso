  ...
  <div class="container">
    <form class='form-inline'>
      ...
      <input style="width: 1100px;" type="number" class="form-control mb-2 mr-sm-2" id="numero" name="numero"
        placeholder="Digite o número do seu local atual:">
      ...
      <input style="width: 1100px;" type="button" value="Mostrar Endereço" class="btn btn-primary" onclick="busca_endereco();">
