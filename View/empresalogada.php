...
$consulta= "SELECT * FROM tb_empresa where email_empresa= '{$email}'";
...
<br>
                    <button style="text-decoration:none; margin-left: 20%;margin-top: 10px; margin-bottom: 5px; width:300px; height: 50px;  background: rgb(6, 141, 6); color: white;" class="btn btn-dark"> <a href="Registrar.php" style="color:white;  text-decoration: none;">
                    <h3>Confirmar coletas</h3></a></button>
                    <button style="text-decoration:none;margin-top: 10px; margin-bottom: 5px; width:300px; height: 50px;  background: rgb(6, 141, 6); color: white;" class="btn btn-dark"> <a href="RegistroColetas.php" style="color:white;  text-decoration: none;">
                    <h3>Registro de coletas</h3></a></button>
                    <button style="margin-top: 10px; margin-bottom: 5px; width:300px; height: 50px;  background: rgb(6, 141, 6); color: white;" class="btn btn-dark"> <a href="paginaUsuario.php" style="color:white;  text-decoration: none;">
                    <h3>Conversas</h3></a></button>
                ...
                <center>
                    <h1 style="color: white;font-variant: 200%;">Dados da empresa</h1>           
                    <img  style="border-radius: 50%; width: 250px;height: 250px;" src="<?php echo "Upload/$empresa[img_empresa]"?>">
                    <h3 style="font-variant: 100%;"><?php echo $empresa["nm_empresa"];?></h3>
                    <h3 style=";font-variant: 100%;"><?php echo $empresa["email_empresa"];?></h3>
                    <h3 style="font-variant: 100%;"><?php echo $empresa["celular_empresa"];?></h3>
                    <button style="margin-bottom: 5px; width:90px; height: 50px;  background:#02240c ; color: white;"
                    type="submit" class="btn btn-dark"> <a href="logout.php" style="color:white;">
                        <h3>Sair</h3></a></button>
