...
$consulta= "SELECT id_usuario FROM tb_usuario where email_usuario= '{$email}'";
$selecionar= $conexao->query($consulta);
while($usuario = $selecionar->fetch_assoc()){ 
   $usu= $usuario["id_usuario"];
}

$consult="SELECT id_coleta, img_empresa, nm_empresa, nm_residuo, d_data FROM tb_coleta a INNER JOIN tb_empresa b ON 
a.id_empresa = b.id_empresa INNER JOIN tb_residuo c ON a.id_residuo = c.Id_residuo 
WHERE id_usuario = '$usu' AND resgistro = 1;";
...
<div id="table" style="color:white">
        <table class="table table-striped" style="color:white;">
            ...
            <tr>
                <td style="color:white">Imagem da empresa</td>
                <td style="color:white">Nome da empresa</td>
            ...
            <tr>
           <td> <img  style="border-radius: 60%; width: 50px;" src="<?php echo "Upload/$dado[img_empresa]"?>"></td>
                <td style="color:white"><?php echo $dado["nm_empresa"];?></td>
